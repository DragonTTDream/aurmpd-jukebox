...
const en = {
	...
	'settings.audioApply': 'Apply',
	'settings.audioRefresh': 'Refresh',
	'settings.audioManualHint': 'This build cannot change the mpd configuration for you. Edit the mpd.conf audio_output block (type / device) and restart mpd manually.',
	'settings.audioApplied': 'Audio output applied.',
	'settings.audioFailed': 'Could not change the audio output.',
	'settings.audioFailedDetail': 'Could not change the audio output: {error}',
	'settings.save': 'Save',
...
const zhCN = {
	...
	'settings.audioOutput': '输出设备',
	'settings.audioApply': '应用',
	'settings.audioRefresh': '刷新',
	'settings.audioManualHint': '本机不支持由程序自动修改 mpd 配置。请手动编辑 mpd.conf 的 audio_output（type / device）并重启 mpd。',
	'settings.audioApplied': '已应用音频输出设置。',
	'settings.audioFailed': '无法修改音频输出。',
	'settings.audioFailedDetail': '无法修改音频输出：{error}',
	'settings.save': '保存',
	'settings.demo': '演示服务器',
	'settings.test': '测试连接',
